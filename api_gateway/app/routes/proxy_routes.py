...
DOCUMENTED_PROXY_ROUTES = [
    ...
    # Group Activities
    ("GET", "/groups/health", "groups", "health", "Groups Health", "Group Activities Service (Proxy)"),
    ("POST", "/groups/api/v1/groups", "groups", "api/v1/groups", "Groups Create Group Set", "Group Activities Service (Proxy)"),
    ("GET", "/groups/api/v1/groups", "groups", "api/v1/groups", "Groups List Groups", "Group Activities Service (Proxy)"),
    ("POST", "/groups/api/v1/groups/{groupId}/members", "groups", "api/v1/groups/{groupId}/members", "Groups Add Member", "Group Activities Service (Proxy)"),
    ("PATCH", "/groups/api/v1/group-memberships/{membershipId}", "groups", "api/v1/group-memberships/{membershipId}", "Groups Update Member Role", "Group Activities Service (Proxy)"),
    ("POST", "/groups/api/v1/group-activities", "groups", "api/v1/group-activities", "Groups Create Activity", "Group Activities Service (Proxy)"),
    ("POST", "/groups/api/v1/group-activities/{activityId}/assign-groups", "groups", "api/v1/group-activities/{activityId}/assign-groups", "Groups Assign Activity Groups", "Group Activities Service (Proxy)"),
    ("GET", "/groups/api/v1/group-activities/{activityId}", "groups", "api/v1/group-activities/{activityId}", "Groups Get Activity", "Group Activities Service (Proxy)"),
    ("POST", "/groups/api/v1/group-submissions", "groups", "api/v1/group-submissions", "Groups Submit Work", "Group Activities Service (Proxy)"),
    ("GET", "/groups/api/v1/group-submissions/{activityId}", "groups", "api/v1/group-submissions/{activityId}", "Groups List Activity Submissions", "Group Activities Service (Proxy)"),
    ("POST", "/groups/api/v1/peer-evaluations", "groups", "api/v1/peer-evaluations", "Groups Submit Peer Evaluation", "Group Activities Service (Proxy)"),
    ("GET", "/groups/api/v1/peer-evaluations/{activityId}", "groups", "api/v1/peer-evaluations/{activityId}", "Groups List Peer Evaluations", "Group Activities Service (Proxy)"),
    ("POST", "/groups/api/v1/group-results/{activityId}/grade", "groups", "api/v1/group-results/{activityId}/grade", "Groups Grade Activity", "Group Activities Service (Proxy)"),
    ("GET", "/groups/api/v1/students/{studentId}/group-activities", "groups", "api/v1/students/{studentId}/group-activities", "Groups Student Activity Feed", "Group Activities Service (Proxy)"),
    ("GET", "/groups/api/v1/classes/{classId}/group-performance", "groups", "api/v1/classes/{classId}/group-performance", "Groups Class Performance", "Group Activities Service (Proxy)"),
    # Homework & Assessment
